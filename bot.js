...
const TIVE_COMPLETO_FIELDS = [
    ...
    { key: 'numero_de_serie', dataKey: 'serie', x: 128.3, y: 206.2, dx: -9, dy: -8, size: 8, bold: false },
    ...
    { key: 'combusble', dataKey: 'combustible', x: 108.6, y: 138.4, dx: -7, dy: -8, size: 8, bold: false },
    { key: 'asientos', dataKey: 'asientos', x: 104.1, y: 108.5, dx: -4, dy: -6, size: 8, bold: false },
    { key: 'pasajeros', dataKey: 'pasajeros', x: 103.1, y: 96.4, dx: -4, dy: -8, size: 8, bold: false },
    { key: 'ruedas', dataKey: 'ruedas', x: 103.9, y: 67, dx: -6, dy: -7, size: 8, bold: false },
    { key: 'ejes', dataKey: 'ejes', x: 103.5, y: 81.8, dx: -5, dy: -6, size: 8, bold: false },
    ...
    { key: 'cilindros', dataKey: 'cilindros', x: 208.6, y: 114.2, dx: -3, dy: -8, size: 8, bold: false },
    { key: 'longitud', dataKey: 'longitud', x: 213.9, y: 100.2, dx: -7, dy: -8, size: 8, bold: false },
    { key: 'altura', dataKey: 'altura', x: 213.9, y: 86.2, dx: -7, dy: -7, size: 8, bold: false },
    { key: 'ancho', dataKey: 'ancho', x: 212.6, y: 71.6, dx: -7, dy: -8, size: 8, bold: false },
    { key: 'cilindro', dataKey: 'cilindrada', x: 333.9, y: 109.6, dx: -5, dy: -8, size: 8, bold: false },
    { key: 'p_bruto', dataKey: 'pBruto', x: 326.6, y: 97.6, dx: -1, dy: -8, size: 8, bold: false },
    { key: 'campo_30', dataKey: 'pNeto', x: 329.9, y: 82.9, dx: -3, dy: -8, size: 8, bold: false },
    { key: 'campo_31', dataKey: 'cargaUtil', x: 322.6, y: 71.6, dx: -3, dy: -8, size: 8, bold: false },
